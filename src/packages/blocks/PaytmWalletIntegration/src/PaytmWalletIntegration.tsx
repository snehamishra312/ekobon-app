...
import PaytmWalletIntegrationController, {
  Props,
  configJSON,
} from "./PaytmWalletIntegrationController";

export default class PaytmWalletIntegration extends PaytmWalletIntegrationController {
