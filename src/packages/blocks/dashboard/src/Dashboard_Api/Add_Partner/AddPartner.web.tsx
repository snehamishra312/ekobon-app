...
import AddPartnerController, {
    Props,
} from "./AddPartnerController.web";
...
export default class AddPartner extends AddPartnerController {
                                ...
                                <form>
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label >Email</label>
                                                <input type="email" onChange={(e) => this.setState({ email: e.target.value })} value={email} id="email" name="email" className="form-control" required />
                                            </div>
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                    ...
                                    <button className="btn btn-primary d-flex align-items-center mx-auto mt-5" onClick={(e) => this.onHandleAddPartner(e)}>Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
