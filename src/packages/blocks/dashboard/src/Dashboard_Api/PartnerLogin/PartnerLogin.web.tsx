...
import PartnerLoginController, {
    Props,
} from "./PartnerLoginController.web";
                        ...
                        <div className="ct_login_bg">
                            <form>
                                <div className="ct_header">
                                    <h4>Welcome to Partner Login Page</h4>
                                    <p>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-4 mb-md-0">
                                        <div className="ct_right_form">
                                            ...
                                            <input className="btn ct_submit_btn mt-4 " id="submit" name="submit" type="submit" value="Log in" onClick={(e) => this.onHandleLoginSubmit(e)}></input>
                                        </div>
                                    </div>
                                </div>
                            </form>
