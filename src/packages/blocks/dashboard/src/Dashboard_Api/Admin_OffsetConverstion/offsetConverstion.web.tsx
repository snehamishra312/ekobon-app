...
import offsetConverstionController, {
    Props,
} from "./offsetConverstionController.web";
...
export default class offsetConverstion extends offsetConverstionController {
                    ...
                    <div className="layout-container">
                        ...
                        <div className="layout-page">
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    {offsetData && offsetData.map((item: any, index: any) => (
                                        <tr>
                                            {/* <td>{index + 1}</td>
