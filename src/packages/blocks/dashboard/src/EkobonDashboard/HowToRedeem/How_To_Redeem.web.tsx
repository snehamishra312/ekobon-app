...
import Pro1Controller, {
    Props,
} from "./How_To_RedeemController.web"
import How_To_RedeemController from "./How_To_RedeemController.web"
import {
    LOGO, White_Logo, Offset, Planet_Earth, Gift_Card, ESG, API11, Carbon_Neutral, Lca_Icon,
    Footer_Shape_3, RedeemImg1, RedeemImg2, RedeemImg3, RedeemImg4, GiftCardImage, SelectProject2
} from '../assets';
export const configJSON = require("../../config");
import axios from "axios";
import { message as MESSAGE } from "antd";

export default class How_To_Redeem extends How_To_RedeemController {
        ...
        return (
            <div className={isDarkMode == true ? 'theme-dark' : 'theme-light'}>
                ...
                <div className="page-wrapper" onScroll={this.handleScroll}>
                    ...
                    <div className="breadcrumb-wrap bg-f ct_how_redeem_gift_bg_1">
                        <div className="container">
                            <div className="breadcrumb-title">
                                <h2>How To Redeem Gifts</h2>
                                <ul className="breadcrumb-menu list-style"><li><a href="/">Home </a></li><li>How To Redeem Gifts</li></ul>
                            </div>
                        </div>
                    </div>
                    <section className="cti_gift_section mt-5">
                        <div className="container">
                            <div className="row">
                                <div className="col-12 col-lg-6 align-self-center">
                                    <div>
                                        <p className="cti_gift_para text-start">Step 1:</p>
                                        <p className="cti_gift_para1 text-start">Sign in / Sign up Ekobon</p>
                                        <p className="cti_gift_para2 text-start">
                                            Enter you details to sign up. Once you have logged in, you will
                                            redirected to your climate dashboard.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-12 col-lg-6 text-center">
                                    <div className="cti_right_image">
                                        <img
                                            src={RedeemImg1}
                                            alt="gift"
                                            className="img-fluid"
                                ...
                                <div className="row flex-column-reverse flex-lg-row mt-5">
                                    ...
                                    <div className="col-12 col-lg-6 align-self-center">
                                        <div>
                                            <p className="cti_gift_para text-start">Step 2:</p>
                                            <p className="cti_gift_para1 text-start">
                                                Select the gift card for redemption
                                            </p>
                                            <p className="cti_gift_para2 text-start">
                                                Go to 'My details {"->"} My gift card' section. Select the gift card you want to redeem
                                           </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="row mt-5">
                                    <div className="col-12 col-lg-6 align-self-center">
                                        <div>
                                            <p className="cti_gift_para text-start">Step 3:</p>
                                            <p className="cti_gift_para1 text-start">
                                                Select the climate <br /> project you want to invest in
                                            </p>
                                            <p className="cti_gift_para2 text-start">
                                                Once you have selected the gift card, you will be redirected to the climate projects page. For generic or travel offset gift cards, you can select the project you are passionate about and funds will be invested in that project.  A confirmation mail will sent later with the gift card details.                                            </p>
                                        </div>
                                    </div>
                                    <div className="col-12 col-lg-6 text-center">
                                        <div className="cti_right_image">
                                ...
                                {/* <div className="row flex-column-reverse flex-lg-row mt-5">
                                    ...
                                    <div className="col-12 col-lg-6 align-self-center">
                                        <div>
                                            <p className="cti_gift_para">Step 4:</p>
                                            <p className="cti_gift_para1">
                                                Put the gift code while <br />
                                                 checking out
                                                       </p>
                                            <p className="cti_gift_para2">
                                                Once the payment is done, you will be taken to the climate
                                                projects page. You can pick the project you are passionate
                                                about and amount will get invested in that project within
                                                certain duration and email confirmation will be sent.
                                                       </p>
                                        </div>
                                    </div>
                                </div> */}
