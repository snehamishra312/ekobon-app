...
$(function () {
    $(".ct_show_more_div").slice(0, 6).show();
    $("body").on('click touchstart', '.load-more', function (e) {
        e.preventDefault();
        $(".ct_show_more_div:hidden").slice(0, 6).slideDown();
        if ($(".ct_show_more_div:hidden").length == 0) {
...
var tabs = document.getElementById('ct_prdct_icetab-container').children;
var tabcontents = document.getElementById('ct_icetab-content').children;

var myFunction = function () {
    var tabchange = this.mynum;
    for (var int = 0; int < tabcontents.length; int++) {
        tabcontents[int].className = ' ct_tabcontent1';
        tabs[int].className = ' ct_prdct_icetab';
    }
    tabcontents[tabchange].classList.add('ct_tab-active');
    this.classList.add('ct_current-tab');
}
