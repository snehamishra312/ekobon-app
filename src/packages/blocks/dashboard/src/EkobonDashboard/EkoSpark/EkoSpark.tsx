...
import Pro1Controller, {
    Props,
} from "./EkoSparkController"
import EkoSparkController from "./EkoSparkController";
import {
    LOGO, White_Logo, Planet_Earth, Gift_Card, ESG, Offset, API11, Carbon_Neutral, Footer_Shape_3, Lca_Icon,
    Eko_Spark_App_Big, Trophy, Tier_bashed_eko_icon, Box, mob_image
} from '../assets';

export default class EkoSpark extends EkoSparkController {
    render() {
        const {
            isSideBarClick,
            isDarkMode,
            ...
            <div className={isDarkMode == true ? 'theme-dark' : 'theme-light'}>
                ...
                <div className="page-wrapper" onScroll={this.handleScroll}>
                    ...
                    <div className="content-wrapper">
                        ...
                        {/* Breadcrumb Start */}
                        <div className="breadcrumb-wrap bg-f ct_service_bg ct_eko_points_bg">
                            <div className="container">
                                <div className="row align-items-center">
                                    <div className="col-md-5" data-aos="fade-up" data-aos-duration="1200"
                                        data-aos-delay="200">
                                        <div className="ct_eko_spark_mob">
                                            <img src={mob_image} />
                                        </div>
                                    </div>
                                    <div className="col-md-7" data-aos="fade-up" data-aos-duration="1200"
                                        data-aos-delay="200">
                                        <div className="ct_eko_spark_bg_title">
                                            <h2> EKO SPARK </h2>
                                            <p className="text-start">Make climate action engaging and get rewarded along the way </p>
                                            <h4 className="ct_coming_soon_text">Coming Soon...</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* Breadcrumb End  */}
                        <section className="ptb-100 pt-5" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="200">
                            <div className="container">
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="text-center">
                                            <h4> Take charge of your climate goals </h4>
                                            <p>Measure your environmental impact, take climate challenges, and earn EKO Points on completion of the tasks. Invite your friends to participate in climate challenge. Redeem EKO Points later to get discount coupons applicable on partner websites.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </section>
                        <section className="ptb-100 pt-0" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="200">
                            <div className="container">
                                <div className="row" >
                                ...
                                <div className="row">
                                    <div className="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-duration="1200"
                                        data-aos-delay="200">
                                        <div className="ct_eko_point_work_box">
                                            <div className="ct_eko_icon">
                                                <img src={Trophy} />
                                            </div>
                                            <div className="ct_eko_point_work_cnt">
                                                <h4>Challenges</h4>
                                                <p>Participate in a challenge and invite your friends for group challenge activities. </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-duration="1200"
                                        ...
                                        <div className="ct_eko_point_work_box">
                                            <div className="ct_eko_icon">
                                                <img src={Tier_bashed_eko_icon} />
                                            </div>
                                            <div className="ct_eko_point_work_cnt">
                                                <h4>Tier based eko points</h4>
                                                <p>Earn eko points on completion of the challenges. Earn more as you go higher up the levels. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-duration="1200"
                                        ...
                                        <div className="ct_eko_point_work_box">
                                            ...
                                            <div className="ct_eko_point_work_cnt">
                                                <h4>Redeem eko points</h4>
                                                <p>Redeem discount vouchers which can be used on partner websites.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
