...
import { LOGO, White_Logo, Planet_Earth, Gift_Card, ESG, Offset, API11, Carbon_Neutral, Footer_Shape_3, Lca_Icon } from '../assets';

export default class Contact extends ContactController {
            ...
            <div className={isDarkMode == true ? 'theme-dark' : 'theme-light'}>
                ...
                <div className="page-wrapper" onScroll={this.handleScroll}>
                    ...
                    <div className="content-wrapper">
                        ...
                        {/* Breadcrumb Start  */}
                        <div className="breadcrumb-wrap bg-f ct_contact_bg">
                            <div className="container">
                        ...
                        <section className="contact-us-wrap ptb-100" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="200">
                            <div className="container">
                                ...
                                <div className="row gx-5 justify-content-center">
                                    <div className="col-lg-8 mb-4">
                                        <div className="contact-form ct_get_quote_form p-0">
                                            <form action="" className="ct_form_wrap">
                                                <div className="row">
                                                ...
                                                <div className="text-center">
                                                    <button className="btn style2 mt-3" onClick={(e) => this.onHandleSubmitDetail(e)}>submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 mb-4">
                                        <div className="contact-item-wrap">
                                            ...
                                            <div className="contact-item">
                                                <h3>Email Address</h3>
                                                <a href="mailto:contactus@ekobon.com"><span className="__cf_email__" >contactus@ekobon.com</span></a>

                                            </div>
                                            <div className="contact-item">
                                                <h3>24/7 Support</h3>
                                                <a href="tel:+919993023823">+919993023823</a>
                                            </div>
                                            <div className="contact-item">
                                                <h3>Follow us</h3>
