...
import VideoEmbeddingYoutubeController, {
  Props,
  configJSON,
} from "./VideoEmbeddingYoutubeController";

export default class VideoEmbeddingYoutube extends VideoEmbeddingYoutubeController {
